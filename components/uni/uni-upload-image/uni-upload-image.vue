            ...
            <view class="uni-uploader-body">
                <view class="uni-uploader__files">
                    <block v-for="(image,index) in imageList" :key="index">
                        <view class="uni-uploader__file u-relative">
                            <image class="uni-uploader__img rounded" 
                            :src="image" :data-src="image" mode="aspectFill"
                                @tap.stop="previewImage"></image>
                                <view class="bg-neutral opacity-60 u-absolute top-0 right-0 px-1 rounded"
                                    @tap="deleteImage(index)">
                                    <text class="iconfont icon-cuo text-white font-weight-bold bg-del rounded-circle del-button" />
                                </view>
                        </view>
                    </block>
