<template>
	<view>		
		...
		<view class="u-p-l-38">
			<view class="iconfont icon-wancheng text-muted" 
			:class="isSelected ? 'text-theme' : ''" @click="isSelected=!isSelected">
				<text class="u-font-14 u-m-l-19 text-muted">阅读并同意《用户协议》</text>
			</view>
		</view>
